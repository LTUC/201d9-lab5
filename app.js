...
function sum(a, b) { //eslint-disable-line
    let s = a + b;
    let s1 = 'The sum of ' + a + ' and ' + b + ' is ' + s + '.';
    console.log(s1)
    return [s, s1]
}
...
function multiply(a, b) { //eslint-disable-line
    var z = a * b;
    var z1 = 'The product of ' + a + ' and ' + b + ' is ' + z + '.';
    console.log(z1);
    return [z, z1];
}
...
//laptop. Don't forget
// to create a new branch for your work on the next question!

/////////////////////////////////////
/* Problem 3
Write a function called sumAndMultiply() that takes in three numbers as separate arguments and 
returns an array where 
the first element is the sum of those three numbers, the second element is the product of those
 three numbers,  and the
 third and fourth elements are strings that EXACTLY follow this example and use the values that were
input into the function:
Third element: "4 and 7 and 5 sum to 16."
Fourth element: "The product of 4 and 7 and 5 is 140."
IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function. To do addition,
 use your sum() function,
 and to do multiplication, use your multiply() function that you've already created. You're going to
  have to be resourceful to
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var x = sum(a, b)[0];
    var xx = sum(x, c)[0];
    var x1 = a + ' and ' + b + ' and ' + c + ' sum to ' + xx + '.';
    console.log(x1);
    var x0 = multiply(a, b)[0];
    var xx0 = multiply(x0, c)[0];
    var x2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + xx0 + '.'
    console.log(x2);
...
argument and then returns an array where the first element is the sum of the numbers in the array, 
and the second element is a string that EXACTLY follows this example and uses the values that were 
input into the function:
"2,3,4 was passed in as an array of numbers, and 9 is their sum."
IMPORTANT DETAIL: You may not use the arithmetic operator + in this function. To do 
addition, use your sum() function that you've already created. You're going to have to be 
resourceful to figure out how to do this. However, you may continue to use the + operator 
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    var c0 = sum(sumArr[0], sumArr[1])[0];
    var c = sum(c0, sumArr[2])[0];

    var c1 = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + c + ' is their sum.';
...
Write a function called multiplyArray() that takes an array of numbers as its argument and returns
 an array whose first element is the product of those numbers, and the second element is a string 
...
function multiplyArray(multArr) { //eslint-disable-line
    let v0 = multiply(multArr[0], multArr[1])[0];
    let v = multiply(v0, multArr[2])[0];
    let v1 = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + v + '.';
...
IMPORTANT DETAIL: You may not use the arithmetic operator * in this function. To do multiplication, use your multiply()
 function that you've already created. You're going to have to be resourceful to figure out how to do this. However, you 
 may continue to use the + operator for string concatenation.
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (let i = 0; i < dynamicArray.length; i++) {
        // console.log(b, dynamicArray[i])

        b = multiply(dynamicArray[i], b)[0];
        //console.log(b, dynamicArray[i])
    }
    let b1 = 'The numbers ' + dynamicArray[0] + ',' + dynamicArray[1] + ',' + dynamicArray[2] + ',' + dynamicArray[3] +
        ',' + dynamicArray[4] + ' have a product of ' + b + '.'
    console.log(b1)
    return [b, b1]
}
...
// Once you get the test passing, do an a-c-p cycle and synchronize the code between GitHub and your laptop. You're done! Submit the
// link to the repo following the instructions in Canvas.