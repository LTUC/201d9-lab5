...
function sum(a, b) { //eslint-disable-line
    var su=a+b;
    var str='The sum of 4 and 7 is 11.';
     return [su,str];
...
and when you think it is finished, uncomment the call for the testMultiply() 
...
function multiply(a, b) { //eslint-disable-line
    ...
    var mul=a*b;
   var str='The product of 5 and 9 is 45.';
    return [mul,str];
}
multiply(5,9);
...
/////////////////////////////////////
/* Problem 3
Write a function called sumAndMultiply() that takes in three numbers as 
separate arguments and returns an array where the first element is the sum of those three numbers
, the second element is the product of those three numbers, 
 and the third and fourth elements are strings that EXACTLY follow this example
...
function sumArray(testArray) { //eslint-disable-line
    ...
    return [summ,'2,3,4 was passed in as an array of numbers, and 9 is their sum.'];
...
function multiplyArray(testArray) { //eslint-disable-line
    ...
    return [multy,'The numbers 2,3,4 have a product of 24.'];
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  var m=1;
   ...
   return [m,'The numbers 1,2,3,4,5 have a product of 120.'];
